...
if __name__ == "__main__":
    ...
    # 模型名称和路径配置
    model_configs = [
        {"name_prefix": "fruit_board_", "path": f"/home/liu/ucar_ws/models/{random.choice(fruit_board_folders)}/model.sdf"},
        {"name_prefix": "vage_board_", "path": f"/home/liu/ucar_ws/models/{random.choice(vege_board_folders)}/model.sdf"},
        {"name_prefix": "dessert_board_", "path": f"/home/liu/ucar_ws/models/{random.choice(dessert_board_folders)}/model.sdf"}
    ]
